...
const AssignGateWaysPage = () => {
  ...
  return (
    <div className='flex flex-col items-start justify-start w-full'>
      ...
      <h1 className='text-2xl mx-auto font-bold text-black'>Gateway</h1>

      <div className="flex flex-col items-start text-center text-sm outline outline-[0.5px] p-3  rounded-md shadow-md">
        <span className="  m-auto font-semibold ">Remaining limits</span>
        <div className="m-auto mx-2">234,123,5</div>
      </div>

      <div className='my-6 w-full '>
        <Label htmlFor="picture">Add limit</Label>
      ...
      <Button className="bg-blue-600 w-[10%] mt-12" > Save </Button>
