...
const WithrawalMoneyRecpiet = (probs: any) => {
    return (
        <>
            <AlertDialog>
                ...
                <AlertDialogContent className='p-0 pb-12 sm:w-[470px] max-h-[75%] overflow-auto'>
                    <div className="flex flex-col w-full ">
                        ...
                        <div className="flex w-full my-3  mt-7 items-center justify-center  gap-3.5">
                            <Label className='text-xl' htmlFor="picture">Withdrawal money successfull</Label>
                        </div>
                        ...
                        <div className="flex w-full mb-4  mt-2 items-center justify-center  gap-3.5">
                            <Label className='text-xl' htmlFor="picture">Payment proof</Label>
                        </div>

                        <Skeleton.Image className='w-full mx-auto'/> 
...
export default WithrawalMoneyRecpiet
