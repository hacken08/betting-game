...
const AddMoneyRecpiet = (probs: any) => {
    return (
        <>
            <AlertDialog>
                ...
                <AlertDialogContent className='p-0 pb-12 sm:w-[470px] max-h-[75%] overflow-auto'>
                    <div className="flex flex-col w-full ">
                        ...
                        <div className="flex w-full my-3  mt-7 items-center justify-center  gap-3.5">
                            <Label className='text-xl' htmlFor="picture">Money Successfully added</Label>
                        </div>

                        <div className='flex  justify-between mx-8 mt-5 items-center'>
                            <div className='flex flex-col'>
                                <span className='font-semibold'>Added amount:</span>
                                <span>2,000.00</span>
                            </div>
                            <div className='flex flex-col items-end'>
                                <span className='font-semibold '>Deposite Method:</span>
                                <span>name of gateway</span>
                            </div>
                        </div>
...
export default AddMoneyRecpiet
