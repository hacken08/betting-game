...
const WithrawalReffundedMoneyrecpiet = (probs: any) => {
    return (
        <>
            <AlertDialog>
                ...
                <AlertDialogContent className='p-0 pb-12 sm:w-[470px] max-h-[75%] overflow-auto'>
                    <div className="flex flex-col w-full ">
                        ...
                        <div className="flex w-full mb-3  mt-9 items-center justify-center  gap-3.5">
                            <Label className='text-xl' htmlFor="picture">Withdrawal money refunded</Label>
                        </div>
...
export default WithrawalReffundedMoneyrecpiet
