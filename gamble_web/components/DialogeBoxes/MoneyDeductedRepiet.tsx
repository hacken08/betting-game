...
const MoneyDeductedRepeit = (probs: any) => {
    return (
        <>
            <AlertDialog>
                ...
                <AlertDialogContent className='p-0 pb-6 sm:w-[470px] max-h-[75%] overflow-auto'>
                    <div className="flex flex-col w-full ">
                        ...
                        <div className="flex w-full my-3  mt-7 items-center justify-center  gap-3.5">
                            <Label className='text-xl' htmlFor="picture">Money Deducted</Label>
                        </div>
                        ...
                        <div className='flex  justify-between mx-8 mt-5 items-center'>
                            ...
                            <div className='flex flex-col items-end'>
                                ...
                                <span className='text-sm'>Money deducted by admin</span>
                            </div>
                        </div>
                        ...
                        <div className='flex w-full justify-center mt-12 text-xs text-center gap-1'>
                           If there is any inquery please contact us on <span className='text-blue-500'> Customer care</span>
                        </div>
                    </div>
                </AlertDialogContent>
            </AlertDialog>
...
export default MoneyDeductedRepeit
